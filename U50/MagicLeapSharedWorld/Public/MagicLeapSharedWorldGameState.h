...
public:
    ...
    UPROPERTY(BlueprintReadWrite, ReplicatedUsing=OnReplicate_SharedWorldData, meta=(AllowPrivateAccess=true))
    FMagicLeapSharedWorldSharedData SharedWorldData;
    
    UPROPERTY(BlueprintReadWrite, ReplicatedUsing=OnReplicate_AlignmentTransforms, meta=(AllowPrivateAccess=true))
