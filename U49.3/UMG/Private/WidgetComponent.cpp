...
UWidgetComponent::UWidgetComponent() {
    this->Space = (EWidgetSpace)208;
    this->TimingPolicy = (EWidgetTimingPolicy)208;
    ...
    this->WindowVisibility = (EWindowVisibility)208;
    this->bApplyGammaCorrection = false;
    this->OwnerPlayer = NULL;
    this->OpacityFromTexture = 1.00f;
    this->BlendMode = (EWidgetBlendMode)208;
    ...
    this->GeometryMode = (EWidgetGeometryMode)208;
    this->CylinderArcAngle = 180.00f;
    this->TickMode = (ETickMode)208;
    this->Widget = NULL;
}
