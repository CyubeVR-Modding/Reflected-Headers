...
UScrollBox::UScrollBox() {
    ...
    this->ScrollBarVisibility = (ESlateVisibility)192;
    this->ConsumeMouseWheel = (EConsumeMouseWheel)192;
    this->AlwaysShowScrollbar = false;
    this->AlwaysShowScrollbarTrack = false;
    this->AllowOverscroll = true;
    this->bAnimateWheelScrolling = false;
    this->NavigationDestination = (EDescendantScrollDestination)192;
    this->NavigationScrollPadding = 0.00f;
    this->ScrollWhenFocusChanges = (EScrollWhenFocusChanges)192;
