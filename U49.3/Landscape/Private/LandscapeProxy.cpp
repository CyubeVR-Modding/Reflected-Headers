...
ALandscapeProxy::ALandscapeProxy() {
    ...
    this->VirtualTextureRenderPassType = (ERuntimeVirtualTextureMainPassType)152;
    ...
    this->CustomDepthStencilWriteMask = (ERendererStencilMask)152;
    ...
    this->NavigationGeometryGatheringMode = (ENavDataGatheringMode)152;
