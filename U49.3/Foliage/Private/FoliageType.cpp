...
UFoliageType::UFoliageType() {
    ...
    this->Scaling = (EFoliageScaling)192;
    ...
    this->VirtualTextureRenderPassType = (ERuntimeVirtualTextureMainPassType)192;
}
