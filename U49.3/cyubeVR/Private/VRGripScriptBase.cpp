...
void UVRGripScriptBase::OnEndPlay_Implementation(const TEnumAsByte<EEndPlayReason::Type> EndPlayReason) {
}
...
UVRGripScriptBase::UVRGripScriptBase() {
    ...
    this->WorldTransformOverrideType = (EGSTransformOverrideType)96;
